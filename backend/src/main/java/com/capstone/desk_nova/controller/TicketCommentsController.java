...
//
//    @GetMapping("/{ticketId}")
//    public ResponseEntity<List<TicketComments>> getCommentsByTicketId(@PathVariable Long ticketId) {
//        List<TicketComments> ticketComments = ticketCommentsService.getCommentsByTicketId(ticketId);
//        return ResponseEntity.ok(ticketCommentsService.getCommentsByTicketId(ticketId));
//    }
//
//    @PostMapping
